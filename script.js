...
const asking = function() {
    ...
    } while (screenPrice === null || !isNumber(screenPrice)); //не число
...
const getAllServicePrices = function() {
    ...
    for (let i = 0; i < 2; i++) {
        ...
        if (i === 0) {
            service1 = prompt("Какой дополнительный тип услуги нужен?", 'sd');
        } else if (i === 1) {
            service2 = prompt("Какой дополнительный тип услуги нужен?", 'ds');
        }
        do {
